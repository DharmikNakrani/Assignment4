...
namespace TestProject1
{
    ...
    public class Test
    {
        ...
        public void InsuranceQuote_Age24_Exp3_Accidents0()
        {
            ...
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "24", "3", "0");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "25", "3", "4");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "35", "9", "2");
            ClickSubmitButton();
            VerifyInsuranceProvided();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123", "d.n@mail.com", "30", "5", "1");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n", "30", "5", "1");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L3G1", "123-123-1234", "d.n@mail.com", "30", "5", "1");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "", "5", "1");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "30", "5", "");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "30", "", "1");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "70", "1", "1");
            ClickSubmitButton();
            VerifyInsuranceRefused();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "16", "0", "0");
            ClickSubmitButton();
            VerifyInsuranceRefused();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "30", "2", "0");
            ClickSubmitButton();
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "40", "20", "3");
            ClickSubmitButton();
            VerifyInsuranceProvided();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "50", "30", "0");
            ClickSubmitButton();
            VerifyInsuranceRateReduced();
        }
        ...
        {
            driver.Navigate().GoToUrl("http://localhost/prog8171a04");
            FillOutForm("D", "N", "123 Main St", "Anytown", "Ontario", "N2L 3G1", "123-123-1234", "d.n@mail.com", "60", "40", "5");
            ClickSubmitButton();
            VerifyInsuranceRefused();
        }
